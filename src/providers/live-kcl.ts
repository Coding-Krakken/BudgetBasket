...
const RSS_URL = "https://thekrazycouponlady.com/feed";
...
export class LiveKclProvider extends BaseProvider {
  readonly id = "live-kcl";
  ...
  async fetchOpportunities(
    ...
    try {
      ...
      return this.failure(`KCL RSS fetch failed: ${err instanceof Error ? err.message : String(err)}`);
    }
  }
}

export const liveKclProvider = new LiveKclProvider();
